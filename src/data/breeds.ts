...
export const breeds: Breed[] = [
  ...
  // ————— 多角度三视图重建（front/side/back/quarter 四视角，颜色高保真）—————
  {
    ...
    description: '多角度重建的灰褐鲭鱼虎斑，翠绿大眼、蓬松球尾，圆嘟嘟的野性小虎',
  ...
  },
  {
    ...
    description: '半长毛棕虎斑配雪白围脖，深色耳尖，森系毛茸茸大尾巴',
  ...
  },
  {
    ...
    description: '长毛棕虎斑配猞猁般的黑色耳簇，蓬松条纹大尾，温柔的巨型猫',
  ...
  },
  {
    ...
    description: '奶油色扁脸大团子，全身软绵绵，铜金色圆眼睛',
  ...
  },
  {
    ...
    description: '海豹色重点配蔚蓝宝石眼，奶白身子深色手套，温顺的仙女猫',
